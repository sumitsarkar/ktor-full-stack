...
data class CreateDistributedHypertable(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (this::class != other::class)
            return false
        val o: CreateDistributedHypertable = other as CreateDistributedHypertable
    ...
    override fun toString(): String {
        val sb = StringBuilder("CreateDistributedHypertable (")
