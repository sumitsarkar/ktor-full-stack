...
open class CreateHypertableRecord() : TableRecordImpl<CreateHypertableRecord>(CreateHypertable.CREATE_HYPERTABLE), Record4<Int?, String?, String?, Boolean?> {
    ...
    override fun field1(): Field<Int?> = CreateHypertable.CREATE_HYPERTABLE.HYPERTABLE_ID
    override fun field2(): Field<String?> = CreateHypertable.CREATE_HYPERTABLE.SCHEMA_NAME
    override fun field3(): Field<String?> = CreateHypertable.CREATE_HYPERTABLE.TABLE_NAME
    override fun field4(): Field<Boolean?> = CreateHypertable.CREATE_HYPERTABLE.CREATED
    ...
    override fun value1(value: Int?): CreateHypertableRecord {
        this.hypertableId = value
        return this
    }

    override fun value2(value: String?): CreateHypertableRecord {
        this.schemaName = value
        return this
    }

    override fun value3(value: String?): CreateHypertableRecord {
        this.tableName = value
        return this
    }

    override fun value4(value: Boolean?): CreateHypertableRecord {
        this.created = value
        return this
    }

    override fun values(value1: Int?, value2: String?, value3: String?, value4: Boolean?): CreateHypertableRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
