...
open class TimeBucket5 : AbstractRoutine<OffsetDateTime>("time_bucket", Public.PUBLIC, SQLDataType.TIMESTAMPWITHTIMEZONE) {
    companion object {
         ...
         */
        val ORIGIN: Parameter<OffsetDateTime?> = Internal.createParameter("origin", SQLDataType.TIMESTAMPWITHTIMEZONE, false, false)
    }
     ...
     */
    fun setOrigin(value: OffsetDateTime?) = setValue(ORIGIN, value)

    /**
     * Set the <code>origin</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    fun setOrigin(field: Field<OffsetDateTime?>): Unit {
