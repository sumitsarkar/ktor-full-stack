...
open class TimeBucketGapfill3 : AbstractRoutine<Long>("time_bucket_gapfill", Public.PUBLIC, SQLDataType.BIGINT) {
    companion object {
         ...
         */
        val START: Parameter<Long?> = Internal.createParameter("start", SQLDataType.BIGINT.defaultValue(DSL.field("NULL::bigint", SQLDataType.BIGINT)), true, false)

        /**
         * The parameter <code>public.time_bucket_gapfill.finish</code>.
         */
        val FINISH: Parameter<Long?> = Internal.createParameter("finish", SQLDataType.BIGINT.defaultValue(DSL.field("NULL::bigint", SQLDataType.BIGINT)), true, false)
    }
