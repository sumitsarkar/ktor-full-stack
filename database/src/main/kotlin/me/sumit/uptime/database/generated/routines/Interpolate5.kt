...
open class Interpolate5 : AbstractRoutine<Double>("interpolate", Public.PUBLIC, SQLDataType.DOUBLE) {
    companion object {
         ...
         */
        val VALUE: Parameter<Double?> = Internal.createParameter("value", SQLDataType.DOUBLE, false, false)
