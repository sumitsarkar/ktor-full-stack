...
open class RecompressChunk : AbstractRoutine<Any>("recompress_chunk", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. Please define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
    ...
    /**
     * Set the <code>chunk</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    fun setChunk(field: Field<Any?>): Unit {
        setField(CHUNK, field)
    }
