...
open class DecompressChunk : AbstractRoutine<Any>("decompress_chunk", Public.PUBLIC, org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"regclass\"")) {
    companion object {
        @Deprecated(message = "Unknown data type. Please define an explicit org.jooq.Binding to specify how this type should be handled. Deprecation can be turned off using <deprecationOnUnknownTypes/> in your code generator configuration.")
         ...
         */
        val IF_COMPRESSED: Parameter<Boolean?> = Internal.createParameter("if_compressed", SQLDataType.BOOLEAN.defaultValue(DSL.field("false", SQLDataType.BOOLEAN)), true, false)
    }
     ...
     */
    fun setIfCompressed(value: Boolean?) = setValue(IF_COMPRESSED, value)

    /**
     * Set the <code>if_compressed</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
    fun setIfCompressed(field: Field<Boolean?>): Unit {
