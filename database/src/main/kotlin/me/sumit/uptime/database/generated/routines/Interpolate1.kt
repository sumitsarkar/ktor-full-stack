...
open class Interpolate1 : AbstractRoutine<Short>("interpolate", Public.PUBLIC, SQLDataType.SMALLINT) {
    companion object {
         ...
         */
        val VALUE: Parameter<Short?> = Internal.createParameter("value", SQLDataType.SMALLINT, false, false)
