...
open class HypertableSize : AbstractRoutine<Long>("hypertable_size", Public.PUBLIC, SQLDataType.BIGINT) {
    companion object {

        /**
         * The parameter <code>public.hypertable_size.RETURN_VALUE</code>.
         */
