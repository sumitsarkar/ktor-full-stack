...
open class TimeBucket6 : AbstractRoutine<LocalDate>("time_bucket", Public.PUBLIC, SQLDataType.LOCALDATE) {
    companion object {
         ...
         */
        val ORIGIN: Parameter<LocalDate?> = Internal.createParameter("origin", SQLDataType.LOCALDATE, false, false)
    }
