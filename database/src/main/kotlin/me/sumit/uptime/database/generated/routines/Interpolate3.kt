...
open class Interpolate3 : AbstractRoutine<Long>("interpolate", Public.PUBLIC, SQLDataType.BIGINT) {
    companion object {
         ...
         */
        val VALUE: Parameter<Long?> = Internal.createParameter("value", SQLDataType.BIGINT, false, false)
